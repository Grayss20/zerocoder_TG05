...
async def start(message: Message):
    await message.answer(
        "Привет! Я бот для поиска котиков. Напиши мне название породы и я пришлю тебе картинку котика.")
